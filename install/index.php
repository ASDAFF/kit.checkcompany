...
class kit_checkcompany extends CModule
{
    const MODULE_ID = 'kit.checkcompany';
    var $MODULE_ID = 'kit.checkcompany';
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage('kit.checkcompany_MODULE_NAME');
        $this->MODULE_DESCRIPTION = GetMessage('kit.checkcompany_MODULE_DESC');
        $this->PARTNER_NAME = GetMessage('kit.checkcompany_PARTNER_NAME');
        $this->PARTNER_URI = GetMessage('kit.checkcompany_PARTNER_URI');
    }
    ...
    function InstallDB($_2060282491 = array())
    {
        ...
        $_1858929349->registerEventHandler('main', 'OnEpilog', self::MODULE_ID, '\Kit\Checkcompany\Eventhandler', 'OnEpilogHandler');
        RegisterModuleDependences('main', 'OnBuildGlobalMenu', self::MODULE_ID, '\Kit\Checkcompany\Eventhandler', 'OnBuildGlobalMenuHandler');
        return true;
    }
    ...
    {
        $_1858929349 = \Bitrix\Main\EventManager::getInstance();
        $_1858929349->unRegisterEventHandler('main', 'OnEpilog', self::MODULE_ID, '\Kit\Checkcompany\Eventhandler', 'OnEpilogHandler');
        UnRegisterModuleDependences('main', 'OnBuildGlobalMenu', self::MODULE_ID, '\Kit\Checkcompany\Eventhandler', 'OnBuildGlobalMenuHandler');
        return true;
    }
